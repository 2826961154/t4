...
mods.bloodmagic.TartaricForge.addRecipe(<bloodmagic:component:2>,[<extrautils2:angelblock>, <botania:rune:3>,<botania:rune:3>,<extendedcrafting:material:8>], 256,128);
...
//急速试剂
mods.bloodmagic.TartaricForge.removeRecipe([<minecraft:cookie>,<minecraft:sugar>,<minecraft:cookie>,<chisel:stonebrick2:4>]);
...
mods.bloodmagic.BloodAltar.addRecipe(<bloodmagic:slate>, <astralsorcery:blockmarble>, 0, 100,60,200);
...
//恶魔坩埚
mods.bloodmagic.TartaricForge.removeRecipe([<minecraft:cauldron>,<chisel:stonebrick1:6>,<minecraft:dye:4>,<minecraft:diamond>]);
...
//恶魔结晶坛
mods.bloodmagic.TartaricForge.removeRecipe([<bloodmagic:soul_forge>,<chisel:stonebrick:11>,<minecraft:dye:4>,<minecraft:glass>]);
